...
int 
mi_status(MI_INFO * info, register MI_ISAMINFO * x, uint flag)
{
	MY_STAT		state;
	...
	if (flag & HA_STATUS_CONST) {
		...
		/*
		 * The following should be included even if we are not
		 * compiling with USE_RAID as the client must be able to
		 * request it!
		 */
