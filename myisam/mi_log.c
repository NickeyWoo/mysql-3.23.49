...
/*
 * Logging of MyISAM commands and records on logfile for debugging The log
 * can be examined with help of the myisamlog command.
 */
...
void 
_myisam_log(enum myisam_log_commands command, MI_INFO * info,
...
void 
_myisam_log_command(enum myisam_log_commands command, MI_INFO * info,
...
void 
_myisam_log_record(enum myisam_log_commands command, MI_INFO * info,
