...
uchar          *
_mi_fetch_keypage(register MI_INFO * info, MI_KEYDEF * keyinfo,
...
int 
_mi_write_keypage(register MI_INFO * info, register MI_KEYDEF * keyinfo,
...
int 
_mi_dispose(register MI_INFO * info, MI_KEYDEF * keyinfo, my_off_t pos)
{
	my_off_t	old_link;
	char		buff      [8];
...
my_off_t 
_mi_new(register MI_INFO * info, MI_KEYDEF * keyinfo)
{
	my_off_t	pos;
	char		buff      [8];
	DBUG_ENTER("_mi_new");
