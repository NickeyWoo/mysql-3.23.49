...
/*
 * * Find current row with read on position or read on key * If inx >= 0 find
 * record using key * Return values: * 0 = Ok. * HA_ERR_KEY_NOT_FOUND = Row
 * is deleted * HA_ERR_END_OF_FILE   = End of file
 */
