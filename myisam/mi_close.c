...
/*
 * TODO: We need to have a separate mutex on the closed file to allow other
 * threads to open other files during the time we flush the cache and close
 * this file
 */
...
int 
mi_close(register MI_INFO * info)
{
	int		error = 0,	flag;
